<div class="bg-blue-950 text-white pb-8 pt-32">
    <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div>
            <h2 class="text-2xl font-bold mb-4">{{ $siteName ?? 'Mon portefolio' }}</h2>
        ...
        <div>
            ...
            <ul class="text-gray-300 space-y-2">
                <li>Email : <a href="mailto:{{ $ownerEmail ?? 'contact@tonsite.com' }}"
                        class="hover:text-white">{{ $ownerEmail ?? 'contact@tonsite.com' }}</a></li>
